...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=777eman&theme=react&hide_border=true" width="40%"/>
...
![HTML5](https://img.shields.io/badge/-HTML5-FF4D00?style=for-the-badge&logo=html5&logoColor=white)
...
| Project | Tech Stack |
|---------|------------|
| 🛍️ **E-Commerce Store** | React, Tailwind |
| 📹 **Security-Camera** | React |
| 📋 **Task Manager** | Python, Tkinter |
| 🎧 **HeadPhones** | HTML, CSS, JS |
| 🎧 **HeadPhones v2** | React |
| 🍽️ **Restaurant** | HTML, CSS, JS |
| 🍕 **Pizza Delivery** | HTML, CSS, JS |
